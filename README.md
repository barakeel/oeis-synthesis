...
If you want to look for other sequences other than OEIS sequences.
Add them to the file `src/data/oeis` following the format of this file
A-number followed by the sequence.
