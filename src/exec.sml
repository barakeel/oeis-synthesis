...
(*
what is stored in the results? 
(prog, (seq,prog) pairs)

seqlh: seq list, prefer smaller
scoreh:



If a program covers n program
global_score: number of covers (tie breaker = size) 
copy from hadamard if it satisfies add it to the table
  
  
be more generous when generating programs.  
*)  
