structure exec_prnn :> exec_prnn =
struct

open HolKernel boolLib aiLib kernel bloom
val ERR = mk_HOL_ERR "exec_prnn"
...
(*  
load "exec_prnn"; open aiLib kernel exec_prnn;
...
load "exec_prnn";  open kernel aiLib exec_prnn;
